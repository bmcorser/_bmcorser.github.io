...
var _user$project$Main$drawEdge = F2(
	function (_p1, _p0) {
		var _p2 = _p1;
		var _p3 = _p0;
		return A2(
...
var _user$project$Main$drawVertex = F2(
	function (label, _p4) {
		var _p5 = _p4;
		var _p7 = _p5._1;
		var _p6 = _p5._0;
						...
						_elm_lang$svg$Svg$text_,
						{
							...
							_1: {
								...
								_0: _elm_lang$svg$Svg_Attributes$y(
									_elm_lang$core$Basics$toString(_p7 + 1)),
								_1: {
									ctor: '::',
									_0: _elm_lang$svg$Svg_Attributes$textAnchor('middle'),
									_1: {
										ctor: '::',
										_0: _elm_lang$svg$Svg_Attributes$fontSize('3'),
										_1: {ctor: '[]'}
									}
								}
							}
...
var _user$project$Main$edgeLength = 10.0;
var _user$project$Main$vertexDegreeLayout = F3(
	function (_p9, degree, _p8) {
		...
		return {
			ctor: '_Tuple2',
			_0: {ctor: '_Tuple2', _0: _p10._0 + (_user$project$Main$edgeLength * dx), _1: _p10._1 + (_user$project$Main$edgeLength * dy)},
			_1: _p11._1
		};
	});
var _user$project$Main$drawTree = function (_p12) {
	var _p13 = _p12;
	var _p17 = _p13._0._1;
	var _p16 = _p13._0._0;
	var _p14 = _p13._1;
	var label = _p14._0;
	var trees = _p14._1;
	var degree = _elm_lang$core$List$length(trees);
	var vertexSvg = A2(
		_user$project$Main$drawVertex,
		label,
		{ctor: '_Tuple2', _0: _p16, _1: _p17});
	var layout = A2(
		_elm_lang$core$List$map,
		A2(
			_user$project$Main$vertexDegreeLayout,
			{ctor: '_Tuple2', _0: _p16, _1: _p17},
			degree),
		A2(
		...
		_elm_lang$core$List$concat(
			{
				...
				_1: {
					ctor: '::',
					_0: A2(_elm_lang$core$List$map, _user$project$Main$drawTree, layout),
					_1: {
						ctor: '::',
						_0: {
							ctor: '::',
...
var _user$project$Main$nextLabel = F3(
	function (list, sequence, index) {
		nextLabel:
		while (true) {
			var _p18 = _elm_lang$core$List$head(list);
			if (_p18.ctor === 'Just') {
				var _p20 = _p18._0;
				if (A2(_elm_lang$core$List$member, _p20, sequence)) {
					var _p19 = _elm_lang$core$List$tail(list);
					if (_p19.ctor === 'Just') {
						var _v8 = _p19._0,
							_v9 = sequence,
							_v10 = index + 1;
...
var _user$project$Main$labelMember = F2(
	function (left, tree) {
		var _p21 = tree;
		var right = _p21._0;
		var trees = _p21._1;
		return _elm_lang$core$Native_Utils.eq(left, right) ? true : A2(
			_elm_lang$core$List$any,
			_user$project$Main$labelMember(left),
			trees);
	});
var _user$project$Main$remaining = F3(
	function (list, index, sequence) {
		var remainingSequence = function () {
			var _p22 = _elm_lang$core$List$tail(sequence);
			if (_p22.ctor === 'Just') {
				return _p22._0;
			} else {
				return {ctor: '[]'};
		...
		return {ctor: '_Tuple2', _0: remainingList, _1: remainingSequence};
	});
var _user$project$Main$constructEdges = F3(
	function (edges, list, sequence) {
		constructEdges:
		while (true) {
			var _p23 = _elm_lang$core$List$head(sequence);
			if (_p23.ctor === 'Just') {
				var _p24 = A3(_user$project$Main$nextLabel, list, sequence, 0);
				if ((_p24.ctor === 'Just') && (_p24._0.ctor === '_Tuple2')) {
					var _p25 = A3(_user$project$Main$remaining, list, _p24._0._1, sequence);
					var remainingList = _p25._0;
					var remainingSequence = _p25._1;
					var _v14 = {
						ctor: '::',
						_0: {ctor: '_Tuple2', _0: _p24._0._0, _1: _p23._0},
						_1: edges
					},
						_v15 = remainingList,
						_v16 = remainingSequence;
					edges = _v14;
					list = _v15;
					sequence = _v16;
					continue constructEdges;
				} else {
					return {ctor: '[]'};
				}
			} else {
				...
				if (((_p26.ctor === '::') && (_p26._1.ctor === '::')) && (_p26._1._1.ctor === '[]')) {
					return {
						ctor: '::',
						_0: {ctor: '_Tuple2', _0: _p26._0, _1: _p26._1._0},
						_1: edges
					};
				} else {
					return {ctor: '[]'};
...
var _user$project$Main$handleInput = F2(
	function (model, input) {
		...
		var n = _elm_lang$core$String$length(input) + 2;
		var _p29 = _elm_community$result_extra$Result_Extra$combine(
			A2(
				_elm_lang$core$List$map,
				_user$project$Main$inputLabel(n),
				strings));
		if (_p29.ctor === 'Err') {
			...
			return _elm_lang$core$Native_Utils.update(
				model,
				{input: input, prufer: _p29._0, error: ''});
		}
	});
...
var _user$project$Main$Model = F3(
	function (a, b, c) {
		return {input: a, prufer: b, error: c};
	});
var _user$project$Main$model = A3(
	...
	'');
var _user$project$Main$Tree = F2(
	function (a, b) {
		return {ctor: 'Tree', _0: a, _1: b};
	});
var _user$project$Main$addEdgeTree = F3(
	function (child, parent, tree) {
		var _p31 = tree;
		var label = _p31._0;
		var trees = _p31._1;
		return _elm_lang$core$Native_Utils.eq(parent, label) ? A2(
			_user$project$Main$Tree,
			label,
			{
				ctor: '::',
				_0: A2(
			...
			A2(
				_elm_lang$core$List$map,
				A2(_user$project$Main$addEdgeTree, child, parent),
				trees));
	});
var _user$project$Main$constructTree = F2(
	function (edges, partialTree) {
		constructTree:
		while (true) {
			var _p32 = {
				ctor: '_Tuple3',
				_0: partialTree,
				_1: _elm_lang$core$List$head(edges),
				_2: _elm_lang$core$List$tail(edges)
			};
			_v21_4:
			do {
				if (_p32._0.ctor === 'Nothing') {
					if (((_p32._1.ctor === 'Just') && (_p32._1._0.ctor === '_Tuple2')) && (_p32._2.ctor === 'Just')) {
						var _v22 = _p32._2._0,
							_v23 = _elm_lang$core$Maybe$Just(
							A2(
								_user$project$Main$Tree,
								_p32._1._0._0,
								{
						...
						edges = _v22;
						partialTree = _v23;
						continue constructTree;
					} else {
						break _v21_4;
					}
				} else {
					if (_p32._1.ctor === 'Just') {
						if (_p32._1._0.ctor === '_Tuple2') {
							if (_p32._2.ctor === 'Just') {
								var _p36 = _p32._0._0;
								var _p35 = _p32._1._0._1;
								var _p34 = _p32._2._0;
								var _p33 = _p32._1._0._0;
								if (A2(_user$project$Main$labelMember, _p35, _p36)) {
									var _v24 = _p34,
										_v25 = _elm_lang$core$Maybe$Just(
										A3(_user$project$Main$addEdgeTree, _p33, _p35, _p36));
									edges = _v24;
									partialTree = _v25;
									continue constructTree;
								} else {
									var _v26 = A2(
										...
										{
											ctor: '::',
											_0: {ctor: '_Tuple2', _0: _p35, _1: _p33},
											_1: {ctor: '[]'}
										}),
										_v27 = _elm_lang$core$Maybe$Just(
										A3(_user$project$Main$addEdgeTree, _p33, _p35, _p36));
									edges = _v26;
									partialTree = _v27;
									continue constructTree;
								...
								var _p39 = _p32._0._0;
								var _p38 = _p32._1._0._1;
								var _p37 = _p32._1._0._0;
								return A2(_user$project$Main$labelMember, _p37, _p39) ? A3(_user$project$Main$addEdgeTree, _p37, _p38, _p39) : (A2(_user$project$Main$labelMember, _p38, _p39) ? A3(_user$project$Main$addEdgeTree, _p38, _p37, _p39) : A2(
									_user$project$Main$Tree,
									-2,
									{ctor: '[]'}));
							}
		...
		{ctor: '[]'},
		{
			...
			_0: A2(
				_elm_lang$html$Html$input,
				{
					...
					_1: {
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$placeholder('Prüfer sequence'),
						_1: {
							ctor: '::',
					...
					_0: A2(
						...
						{ctor: '[]'},
						{
							...
							_0: _elm_lang$html$Html$text(
								_elm_lang$core$Basics$toString(model.prufer)),
							_1: {ctor: '[]'}
						}),
					_1: {
						ctor: '::',
